...
create_token(
  ...
  consumer_key = 'Vto757F3nGIAcj1BLCmHEsRvb',
  consumer_secret =  'jbGQQXiSXHlpD6XDJwyIfzu2O0jijODLFhqydpGElRztM5qP1p',
  access_token = '1272250817064710147-0Hy0yNcj9nqiAsp6U23Rl3MBOlsdvX',
  access_secret = 'LYPYAUvDvhb1idOr1CdAOYOSY3AByNAlwEjqZdGlecUVa')
